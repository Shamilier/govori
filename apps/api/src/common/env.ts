...
const envSchema = z.object({
  ...
  VOXIMPLANT_SERVICE_ACCOUNT_JSON: z.string().optional(),
  VOXIMPLANT_SERVICE_ACCOUNT_KEY_PATH: z.string().optional(),
  VOXIMPLANT_RECORDING_AUTH_HEADER: z.string().optional(),

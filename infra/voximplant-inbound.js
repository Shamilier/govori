...
VoxEngine.addEventListener(AppEvents.CallAlerting, async function(event) {
    ...
    Logger.write("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    Logger.write("📞 INBOUND CALL — GovorI v3.0 + Gemini");
    ...
    try {
        ...
        if (!externalTtsEnabled && backendVoiceRaw && backendVoiceRaw !== voiceName) {
            Logger.write(
                "⚠️ Backend voice \"" +
                    backendVoiceRaw +
        ...
        Logger.write(
            externalTtsEnabled
                ? "🎉 READY — GovorI v3.0 + Gemini Text + ElevenLabs"
                : "🎉 READY — GovorI v3.0 + Gemini Live"
        );
        Logger.write("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    } catch (error) {
        Logger.write("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
